...
--
-- Host: 127.0.0.1
-- Generation Time: 10 أكتوبر 2018 الساعة 01:01
...
('abdxax@gmail.com', 'Fahadssss', 1, '0568508989', '2018-10-04 21:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `request_maintenance` (
  ...
  `Note` text COLLATE utf8_unicode_ci NOT NULL,
  `craete_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `update_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `status` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `request_maintenance`
  MODIFY `id_requiest` int(11) NOT NULL AUTO_INCREMENT;
